...
class GetEvenUnevenTimes extends Base
{
    ...
    protected function init()
    {
        ...
        $this->name          = Piwik::translate('EvenUnevenTimes_EvenUnevenTimes');
        $this->dimension     = null;
        ...
        // If a menu title is specified, the report will be displayed in the menu
         $this->menuTitle    = 'EvenUnevenTimes_EvenUnevenTimes';
        ...
        // exported as a widget
         $this->widgetTitle  = 'EvenUnevenTimes_EvenUnevenTimes';
    }
    ...
    {
        $view = new View('@EvenUnevenTimes/getEvenUnevenTimes');
        $view->myData = array();
